...
Neste projeto simples, apliquei conceitos fundamentais de Python:

* ✔ **Estruturas condicionais:** `if`, `elif` e `else` para validação de regras.
* ✔ **Laços de repetição:** `while` para manter o jogo ativo ou validar entradas.
* ✔ **Tratamento de erros:** `try / except` para evitar que o jogo trave caso o usuário digite algo inválido.
